        ...
        case "bb_smile":
          return (
            <animated.svg id="eyes" style={{...style, ...eyeSpring}}>
              <path d={`M ${EYE_XL-EYE_W_HALF-40} ${EYE_Y+EYE_H_HALF} 
                      A ${EYE_W_HALF+60} ${EYE_H_HALF} 
                      0 0 1 
                      ${EYE_XL+EYE_W_HALF+40} ${EYE_Y+EYE_H_HALF}`} 
                  fill="none" 
                  stroke="#bdff66" 
                  strokeWidth={`${STROKE+20}`}
                  strokeLinejoin="round"
              />
              <path d={`M ${EYE_XR-EYE_W_HALF-40} ${EYE_Y+EYE_H_HALF} 
                      A ${EYE_W_HALF+60} ${EYE_H_HALF} 
                      0 0 1 
                      ${EYE_XR+EYE_W_HALF+40} ${EYE_Y+EYE_H_HALF}`} 
                  fill="none" 
                  stroke="#bdff66" 
                  strokeWidth={`${STROKE+20}`}
                  strokeLinejoin="round"
